...
class DataAssignObserver extends AbstractDataAssignObserver
{
    ...
    public function execute(Observer $observer)
    {
        ...
        $payment->setCompanyName($additionalData->getData('company_name'));
        // $payment->setCcNumber($additionalData->getData('cc_number'));
        // $payment->setCcExp($additionalData->getData('cc_exp'));
        // $payment->setCcCvv($additionalData->getData('cc_cvv'));
    }
}