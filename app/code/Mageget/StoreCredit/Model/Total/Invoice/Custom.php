 ...
 */
namespace Mageget\StoreCredit\Model\Total\Invoice;
 ...
 * Discount invoice
 */
class Custom extends \Magento\Sales\Model\Order\Invoice\Total\AbstractTotal
{
    /**
     * Collect invoice
     *
    ...
    public function collect(Invoice $invoice)
    {
        ...
        $totalDiscountAmount = $invoice->getOrder()->getStorecredit();
