...
return [
    'modules' => [
        ...
        'Magecomp_Extrafee' => 1,
        'Magecomp_Orderconfirmmail' => 1,
        'Mageget_Checkout' => 1,
        'Mageget_Countdown' => 1,
        'Mageget_Customproductpage' => 1,
        'Mageget_OfflinePayment' => 0,
        'Mageget_StoreCredit' => 0,
        'Mageplaza_Core' => 1,
        'Mageplaza_Smtp' => 1,
        'Md_Blog' => 1,
        'PayPal_Braintree' => 0,
        'PayPal_BraintreeGraphQl' => 0,
        'Pekebyte_UnitTests' => 1,
        'Temando_ShippingRemover' => 0,
        'Thecoachsmb_Backendtheme' => 0,
        'Vertex_Tax' => 0,
