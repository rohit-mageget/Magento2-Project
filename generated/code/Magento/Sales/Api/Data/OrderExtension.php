...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
     ...
     * @return string|null
     */
    public function getMyCustomOrderAttribute()
    {
        return $this->_get('my_custom_order_attribute');
    }

    /**
     * @param string $myCustomOrderAttribute
     * @return $this
     */
    public function setMyCustomOrderAttribute($myCustomOrderAttribute)
    {
        $this->setData('my_custom_order_attribute', $myCustomOrderAttribute);
        return $this;
    }
}
