...
var config = {
    "map": {
        "*": {
            'Magento_Checkout/js/model/shipping-save-processor/default': 'Mageget_Checkout/js/model/shipping-save-processor/default'
        }
    }
};
require.config(config);
...
var config = {
    map: {
       '*': {
          'Magento_Swatches/js/swatch-renderer':'Mageget_Customproductpage/js/swatch-renderer'
       }
    }
 };
require.config(config);
